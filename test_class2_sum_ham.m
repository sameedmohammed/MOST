...
clc
filename1 = 'class2-sum-hamP2.xlsx';
filename2 = 'class2-sum-hamPOP2.xlsx';
filename3 = 'class2-sum-hamP2-con.xlsx';
filenamerand1 = 'rand-class2-sum-hamP2.xlsx';
filenamerand2 = 'rand-class2-sum-hamPOP2.xlsx';
filenamerand3 = 'rand-class2-sum-hamP2-con.xlsx';
...
for i = 1:100  
    ...
    [x,fval,flag,output,population] = gamultiobj(@multiobj_fit_class2_sum_ham,200,[],[],[],[],[],[],opts);
