function xoverKids = crossover_test_suite_1(parents,options,NVARS, ...
FitnessFcn,thisScore,thisPopulation)
disp ( ' in cross over')
filename = 'crossover.xlsx';
%disp(thisScore)
%xlswrite(filename,thisScore);
    ...
    if(len1 == 1 || len2 == 1)
        ...
        switch random
            case 1
                ...
                %geneLength1 = delim1(toBeXovered1+1)- delim1(toBeXovered1);

                %geneLength2 = delim2(toBeXovered2+1)- delim1(toBeXovered2);
...
xoverLen = length(xoverKids);
scores = zeros (xoverLen,4);
for j = 1 : xoverLen
            
            scores(j,:)= multiobjective_fitness_4_3(xoverKids{j});
end
