...
clc
filename1 = 'class2-sum-levenP2.xlsx';
filename2 = 'class2-sum-levenPOP2.xlsx';
filename3 = 'class2-sum-levenP2-con.xlsx';
filenamerand1 = 'rand-class2-sum-levenP2.xlsx';
filenamerand2 = 'rand-class2-sum-levenPOP2.xlsx';
filenamerand3 = 'rand-class2-sum-levenP2-con.xlsx';
...
for i = 1:100  
    ...
    [x,fval,flag,output,population] = gamultiobj(@multiobj_fit_class2_sum_leven,200,[],[],[],[],[],[],opts);
