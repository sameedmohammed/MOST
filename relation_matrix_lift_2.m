function element = relation_matrix_lift_2(x,y)
...
matrix{3,3} = [0,40,-2,999999,0,0,28,1];
matrix{4,4} = [0,40,-2,999999,0,0,28,1];
matrix{5,5} = [0,40,0,40,0,0,28,0];
matrix{6,6} = [0,40,0,40,0,0,28,0];
matrix{7,7} = [-2,999999,0,0,0,0,8,1];
matrix{8,8} = [-2,999999,0,0,0,0,8,1];
matrix{9,9} = [0,40,-2,999999,0,0,28,1];
matrix{10,10} = [0,40,-2,999999,0,0,28,1];
...
matrix{15,15} = [0,40,-2,999999,0,0,28,1];
matrix{16,16} = [0,40,-2,999999,0,0,28,1];
matrix{17,17} = [0,40,0,40,0,0,28,0];
matrix{18,18} = [0,40,0,40,0,0,28,0];
matrix{19,19} = [0,40,-2,999999,0,0,28,1];
matrix{20,20} = [0,40,0,0,0,0,12,0];
matrix{21,21} = [0,40,0,0,0,0,12,0];
matrix{22,22} = [0,40,-2,999999,0,0,28,1];
matrix{23,23} = [0,40,-2,999999,0,0,28,1];
...
matrix{3,1} = [-2,999999,-2,999999,0,0,28,1];
matrix{3,2} = [-2,0,-1,36,0,0,28,1];
matrix{3,4} = [0,40,-2,999999,0,0,28,1];
matrix{3,5} = [0,40,-2,999999,0,0,28,1];
matrix{3,6} = [0,40,-2,999999,0,0,28,1];
matrix{3,7} = [-2,999999,-2,999999,0,0,28,1];
matrix{3,8} = [-2,0,-1,36,0,0,28,1];
matrix{3,9} = [0,40,-2,999999,0,0,28,1];
matrix{3,10} = [0,40,-2,999999,0,0,28,1];
matrix{3,11} = [0,40,-2,999999,0,0,28,1];
matrix{3,12} = [0,40,-2,999999,0,0,28,1];
matrix{3,13} = [-2,999999,-2,999999,0,0,28,1];
matrix{3,14} = [-2,0,-1,36,0,0,28,1];
matrix{3,15} = [0,40,-2,999999,0,0,28,1];
matrix{3,16} = [0,40,-2,999999,0,0,28,1];
matrix{3,17} = [0,40,-2,999999,0,0,28,1];
matrix{3,18} = [0,40,-2,999999,0,0,28,1];
matrix{3,19} = [0,40,-2,999999,0,0,28,1];
matrix{3,20} = [0,40,-2,999999,0,0,28,1];
matrix{3,21} = [0,40,-2,999999,0,0,28,1];
matrix{3,22} = [0,40,-2,999999,0,0,28,1];
matrix{3,23} = [0,40,-2,999999,0,0,28,1];
matrix{3,24} = [0,40,-2,999999,0,0,28,1];

matrix{4,1} = [-2,999999,-2,999999,0,0,28,1];
matrix{4,2} = [-2,0,-1,36,0,0,28,1];
matrix{4,3} = [0,40,-2,999999,0,0,28,1];
matrix{4,5} = [0,40,-2,999999,0,0,28,1];
matrix{4,6} = [0,40,-2,999999,0,0,28,1];
matrix{4,7} = [-2,999999,-2,999999,0,0,28,1];
matrix{4,8} = [-2,0,-1,36,0,0,28,1];
matrix{4,9} = [0,40,-2,999999,0,0,28,1];
matrix{4,10} = [0,40,-2,999999,0,0,28,1];
...
matrix{4,15} = [0,40,-2,999999,0,0,28,1];
matrix{4,16} = [0,40,-2,999999,0,0,28,1];
matrix{4,17} = [0,40,-2,999999,0,0,28,1];
matrix{4,18} = [0,40,-2,999999,0,0,28,1];
matrix{4,19} = [0,40,-2,999999,0,0,28,1];
matrix{4,20} = [0,40,-2,999999,0,0,28,1];
matrix{4,21} = [0,40,-2,999999,0,0,28,1];
matrix{4,22} = [0,40,-2,999999,0,0,28,1];
matrix{4,23} = [0,40,-2,999999,0,0,28,1];
matrix{4,24} = [0,40,-2,999999,0,0,28,1];
...
matrix{9,1} = [-2,999999,-2,999999,0,0,28,1];
matrix{9,2} = [-2,0,-1,36,0,0,28,1];
matrix{9,3} = [0,40,-2,999999,0,0,28,1];
matrix{9,4} = [0,40,-2,999999,0,0,28,1];
matrix{9,5} = [0,40,-2,999999,0,0,28,1];
matrix{9,6} = [0,40,-2,999999,0,0,28,1];
matrix{9,7} = [-2,999999,-2,999999,0,0,28,1];
matrix{9,8} = [-2,0,-1,36,0,0,28,1];
matrix{9,10} = [0,40,-2,999999,0,0,28,1];
matrix{9,11} = [0,40,-2,999999,0,0,28,1];
matrix{9,12} = [0,40,-2,999999,0,0,28,1];
matrix{9,13} = [-2,999999,-2,999999,0,0,28,1];
matrix{9,14} = [-2,0,-1,36,0,0,28,1];
matrix{9,15} = [0,40,-2,999999,0,0,28,1];
matrix{9,16} = [0,40,-2,999999,0,0,28,1];
matrix{9,17} = [0,40,-2,999999,0,0,28,1];
matrix{9,18} = [0,40,-2,999999,0,0,28,1];
matrix{9,19} = [0,40,-2,999999,0,0,28,1];
matrix{9,20} = [0,40,-2,999999,0,0,28,1];
matrix{9,21} = [0,40,-2,999999,0,0,28,1];
matrix{9,22} = [0,40,-2,999999,0,0,28,1];
matrix{9,23} = [0,40,-2,999999,0,0,28,1];
matrix{9,24} = [0,40,-2,999999,0,0,28,1];

matrix{10,1} = [-2,999999,-2,999999,0,0,28,1];
matrix{10,2} = [-2,0,-1,36,0,0,28,1];
matrix{10,3} = [0,40,-2,999999,0,0,28,1];
matrix{10,4} = [0,40,-2,999999,0,0,28,1];
matrix{10,5} = [0,40,-2,999999,0,0,28,1];
matrix{10,6} = [0,40,-2,999999,0,0,281];
matrix{10,7} = [-2,999999,-2,999999,0,0,28,1];
matrix{10,8} = [-2,0,-1,36,0,0,28,1];
matrix{10,9} = [0,40,-2,999999,0,0,28,1];
matrix{10,11} = [0,40,-2,999999,0,0,28,1];
matrix{10,12} = [0,40,-2,999999,0,0,28,1];
matrix{10,13} = [-2,999999,-2,999999,0,0,28,1];
matrix{10,14} = [-2,0,-1,36,0,0,28,1];
matrix{10,15} = [0,40,-2,999999,0,0,28,1];
matrix{10,16} = [0,40,-2,999999,0,0,28,1];
matrix{10,17} = [0,40,-2,999999,0,0,28,1];
matrix{10,18} = [0,40,-2,999999,0,0,28,1];
matrix{10,19} = [0,40,-2,999999,0,0,28,1];
matrix{10,20} = [0,40,-2,999999,0,0,28,1];
matrix{10,21} = [0,40,-2,999999,0,0,28,1];
matrix{10,22} = [0,40,-2,999999,0,0,28,1];
matrix{10,23} = [0,40,-2,999999,0,0,28,1];
matrix{10,24} = [0,40,-2,999999,0,0,28,1];
...
matrix{15,1} = [-2,999999,-2,999999,0,0,28,1];
matrix{15,2} = [-2,0,-1,36,0,0,28,1];
matrix{15,3} = [0,40,-2,999999,0,0,28,1];
matrix{15,4} = [0,40,-2,999999,0,0,28,1];
...
matrix{15,9} = [0,40,-2,999999,0,0,28,1];
matrix{15,10} = [0,40,-2,999999,0,0,28,1];
matrix{15,11} = [0,40,-2,999999,0,0,28,1];
matrix{15,12} = [0,40,-2,999999,0,0,28,1];
matrix{15,13} = [-2,999999,-2,999999,0,0,28,1];
matrix{15,14} = [-2,0,-1,36,0,0,28,1];
matrix{15,16} = [0,40,-2,999999,0,0,28,1];
matrix{15,17} = [0,40,-2,999999,0,0,28,1];
matrix{15,18} = [0,40,-2,999999,0,0,28,1];
matrix{15,19} = [0,40,-2,999999,0,0,28,1];
matrix{15,20} = [0,40,-2,999999,0,0,28,1];
matrix{15,21} = [0,40,-2,999999,0,0,28,1];
matrix{15,22} = [0,40,-2,999999,0,0,28,1];
matrix{15,23} = [0,40,-2,999999,0,0,28,1];
matrix{15,24} = [0,40,-2,999999,0,0,28,1];

matrix{16,1} = [-2,999999,-2,999999,0,0,28,1];
matrix{16,2} = [-2,0,-1,36,0,0,28,1];
matrix{16,3} = [0,40,-2,999999,0,0,28,1];
matrix{16,4} = [0,40,-2,999999,0,0,28,1];
...
matrix{16,9} = [0,40,-2,999999,0,0,28,1];
matrix{16,10} = [0,40,-2,999999,0,0,28,1];
...
matrix{16,15} = [0,40,-2,999999,0,0,28,1];
matrix{16,17} = [0,40,-2,999999,0,0,28,1];
matrix{16,18} = [0,40,-2,999999,0,0,28,1];
matrix{16,19} = [0,40,-2,999999,0,0,28,1];
matrix{16,20} = [0,40,-2,999999,0,0,28,1];
matrix{16,21} = [0,40,-2,999999,0,0,28,1];
matrix{16,22} = [0,40,-2,999999,0,0,28,1];
matrix{16,23} = [0,40,-2,999999,0,0,28,1];
matrix{16,24} = [0,40,-2,999999,0,0,28,1];
...
matrix{19,1} = [-2,999999,-2,999999,0,0,28,1];
matrix{19,2} = [-2,0,-1,36,0,0,28,1];
matrix{19,3} = [0,40,-2,999999,0,0,28,1];
matrix{19,4} = [0,40,-2,999999,0,0,28,1];
...
matrix{19,9} = [0,40,-2,999999,0,0,28,1];
matrix{19,10} = [0,40,-2,999999,0,0,28,1];
...
matrix{19,15} = [0,40,-2,999999,0,0,28,1];
matrix{19,16} = [0,40,-2,999999,0,0,28,1];
matrix{19,17} = [0,40,-2,999999,0,0,28,1];
matrix{19,18} = [0,40,-2,999999,0,0,28,1];
matrix{19,20} = [0,40,-2,999999,0,0,28,1];
matrix{19,21} = [0,40,-2,999999,0,0,28,1];
matrix{19,22} = [0,40,-2,999999,0,0,28,1];
matrix{19,23} = [0,40,-2,999999,0,0,28,1];
matrix{19,24} = [0,40,-2,999999,0,0,28,1];
...
matrix{22,1} = [-2,999999,-2,999999,0,0,28,1];
matrix{22,2} = [-2,0,-1,36,0,0,28,1];
matrix{22,3} = [0,40,-2,999999,0,0,28,1];
matrix{22,4} = [0,40,-2,999999,0,0,28,1];
matrix{22,5} = [0,40,-2,999999,0,0,28,1];
matrix{22,6} = [0,40,-2,999999,0,0,28,1];
matrix{22,7} = [-2,999999,-2,999999,0,0,28,1];
matrix{22,8} = [-2,0,-1,36,0,0,28,1];
matrix{22,9} = [0,40,-2,999999,0,0,28,1];
matrix{22,10} = [0,40,-2,999999,0,0,28,1];
matrix{22,11} = [0,40,-2,999999,0,0,28,1];
matrix{22,12} = [0,40,-2,999999,0,0,28,1];
matrix{22,13} = [-2,999999,-2,999999,0,0,28,1];
matrix{22,14} = [-2,0,-1,36,0,0,28,1];
matrix{22,15} = [0,40,-2,999999,0,0,28,1];
matrix{22,16} = [0,40,-2,999999,0,0,28,1];
matrix{22,17} = [0,40,-2,999999,0,0,28,1];
matrix{22,18} = [0,40,-2,999999,0,0,28,1];
matrix{22,19} = [0,40,-2,999999,0,0,28,1];
matrix{22,20} = [0,40,-2,999999,0,0,28,1];
matrix{22,21} = [0,40,-2,999999,0,0,28,1];
matrix{22,23} = [0,40,-2,999999,0,0,28,1];
matrix{22,24} = [0,40,-2,999999,0,0,28,1];

matrix{23,1} = [-2,999999,-2,999999,0,0,28,1];
matrix{23,2} = [-2,0,-1,36,0,0,28,1];
matrix{23,3} = [0,40,-2,999999,0,0,28,1];
matrix{23,4} = [0,40,-2,999999,0,0,28,1];
...
matrix{23,9} = [0,40,-2,999999,0,0,28,1];
matrix{23,10} = [0,40,-2,999999,0,0,28,1];
matrix{23,11} = [0,40,-2,999999,0,0,28,1];
matrix{23,12} = [0,40,-2,999999,0,0,28,1];
matrix{23,13} = [-2,999999,-2,999999,0,0,28,1];
matrix{23,14} = [-2,0,-1,36,0,0,28,1];
matrix{23,15} = [0,40,-2,999999,0,0,28,1];
matrix{23,16} = [0,40,-2,999999,0,0,28,1];
matrix{23,17} = [0,40,-2,999999,0,0,28,1];
matrix{23,18} = [0,40,-2,999999,0,0,28,1];
matrix{23,19} = [0,40,-2,999999,0,0,28,1];
matrix{23,20} = [0,40,-2,999999,0,0,28,1];
matrix{23,21} = [0,40,-2,999999,0,0,28,1];
matrix{23,22} = [0,40,-2,999999,0,0,28,1];
matrix{23,24} = [0,40,-2,999999,0,0,28,1];
