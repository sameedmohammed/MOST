...
clc
filename1 = 'class2-adw-diceP2.xlsx';
filename2 = 'class2-adw-dicePOP2.xlsx';
filename3 = 'class2-adw-diceP2-con.xlsx';
filenamerand1 = 'rand-class2-adw-diceP2.xlsx';
filenamerand2 = 'rand-class2-adw-dicePOP2.xlsx';
filenamerand3 = 'rand-class2-adw-diceP2-con.xlsx';
...
% generate and store 20 random numbers between 1 and 100
...
for i = 1:100  
    ...
    [x,fval,flag,output,population] = gamultiobj(@multiobj_fit_class2_adw_dice,200,[],[],[],[],[],[],opts);
