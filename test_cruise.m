clc
filename1 = 'cruise-kw-diceP2-2.xlsx';
filename2 = 'cruise-kw-dicePOP2-2.xlsx';
filename3 = 'cruise-kw-diceP2-con.xlsx';
...
while (i < 21)  
    if(randi([1,5])== 1)
        [x,fval,flag,output,population] = gamultiobj(@multiobjective_fitness_cruise2,200,[],[],[],[],[],[],opts);
